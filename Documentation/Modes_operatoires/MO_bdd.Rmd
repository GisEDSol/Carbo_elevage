...
La Base de données Géographique des Sols de France (BDGSF) représente la partie française de la Base de Données Géographique des Sols d'Europe à 1/1000000. La construction est basée sur le principe des Unité Cartographique de Sol (UCS) et des Unités Typologique de Sol (UTS).
...
- Un dictionnaire de la base de [données](http://eusoils.jrc.ec.europa.eu/ESDB_Archive/ESDBv2/popup/sg_dict.htm),
- Une [description](http://eusoils.jrc.ec.europa.eu/ESDB_Archive/ESDBv2/popup/sg_attr.htm) des codes attributaires.
