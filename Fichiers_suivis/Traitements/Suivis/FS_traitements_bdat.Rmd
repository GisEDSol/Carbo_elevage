...
res.pca <- PCA(dcast.bdat_variables[,-(length(vNames))], graph = FALSE)
...
fviz_pca_biplot(res.pca, label="var",habillage=dcast.bdat_variables$zonage_simple,
...
#grdcultures1988,grdcultures2000,grdcultures2010
#elevagehorsol1988,elevagehorsol2000,elevagehorsol2010
#polyelevage1988,polyelevage2000,polyelevage2010
#ugbta1988,ugbta2000,ugbta2010

Rcovar <- c("ugbgrani_sau2010","ttemp_an","jfroids_an","jchauds_an","hpluie_an","ugbta1988","p_prairie1970","p_prairie1979","p_prairie1988","p_sth1970","p_sth1979","p_sth1988","p_sfp1970","p_sfp1979","p_sfp1988","p_mf1970","p_mf1979","p_mf1988","p_c1970","p_c1979","p_c1988","grdcultures1988","elevagehorsol1988","polyelevage1988","clc21_90","clc22_90","clc23_90","clc24_90","clc31_90","ttmean")# Rajouter la topo, pour le moment, nom de variable temporaire
...
# Utilisation de caret, car plus rapide qu'une simple fonction gbm ou cubist
...
# Voir si il y a des différences avec la stratification ?

# Voir dans le détail la démarche. Parfois, le nombre d'échantillon n'est pas suffisant. Revoir aussi la construction du graphique.
# Dans l'idée, ça semble intéressant à approfondir.
registerDoMC(4) # Nombre de processeurs activés
p <- list()
for(i in levels(dcast.bdat$zonage_simple)){
  ...
  varimport$importance <- with(varimport, factor(importance, levels = rev(levels(importance))))

  varimport <- varimport[1:10,]

  p[[i]] <- ggplot(varimport, aes(x = variable, y = importance,)) + 
...
from <- c("hpluie_an","jchauds_an","jfroids_an","p_sfp1988","ttemp_an","polyelevage1988","jach00","sth00","four00","mod17a3mean_00_09","firedensity","entropie06","occup")
to <- c("topo","topo","pedo","pedo","pedo","anthrop","anthrop","anthrop","anthrop","anthrop","anthrop","anthrop","anthrop")
MeanimportVar$type  <- gsub2(from,to,MeanimportVar$type)
...
from <- c("hpluie_an","jchauds_an","jfroids_an","ttemp_an","p_sfp1988","polyelevage1988","p_prairie1988","p_sfp1979","p_sfp1970","p_prairie1970","p_mf1988","p_sth1979","p_c1988","p_c1979","p_sth1988","p_c1970","p_sth1970","p_prairie1979","p_mf1979","clc31_90")         
to <- c("climat","climat","climat","climat","occup","occup","occup","occup","occup","occup","occup","occup","occup","occup","occup","occup","occup","occup","occup","occup")
...
Regard sur les courbes de fréquences cumulées avec la figure `r fig$ref("cdf_regelevage_clim",link=TRUE)`
