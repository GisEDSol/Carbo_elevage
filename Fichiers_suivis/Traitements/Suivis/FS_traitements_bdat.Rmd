...
Ci-dessous, le zoom sur les fréquences cumulées des classes de valeurs en carbone organique les plus mobilisées (entre 14 et 45 g/kg)
...
# Courbe de fréquence cumulée
cdfzoom <- ggplot(melted.bdat[(melted.bdat$value > 17) & (melted.bdat$value < 45) ,], aes(x=value))+
       stat_ecdf(aes(colour=annees))+
       scale_color_manual(values=colors, 
                          name="Périodes")+
       scale_x_continuous(xlabel)+scale_y_continuous(ylabel)+
