...
A faire, rajouter les strates et les régions voir département dans la modélisation nationale de l'évolution des teneurs en CO.AFAIRE AFAIRE
...
save(drest,file=paste(repsortie,"drestcubistdiff_fr_",nbr,".RData",sep=""))
save(dimpvar,file=paste(repsortie,"dimpvarcubistdiff_fr_",nbr,".RData",sep=""))
save(dR2,file=paste(repsortie,"dR2varcubistdiff_fr_",nbr,".RData",sep=""))
save(dRMSE,file=paste(repsortie,"dRMSEpvarcubistdiff_fr_",nbr,".RData",sep=""))
```
...
tt <- do.call(grid.arrange,p)
ggsave(tt,file = paste(repsortie,"boxplot_diffregelevage_prairie.png",sep=""), width = 17, height = 10)  
