...
histo_regelevage <- ggplot(bdatdiff,aes(diff,fill=zonage_cplt)) + geom_bar() + facet_wrap(~ period) #geom_bar(position="dodge")
histo_regelevage
```
...
ggplot(dcast.bdat, aes(ttmean,meancorgox9599_0509)) +
  geom_point(aes(colour = factor(diff24)), size = 4) +
  geom_point(colour="grey10", size = 1.5)# + facet_wrap(~ zonage_cplt)
