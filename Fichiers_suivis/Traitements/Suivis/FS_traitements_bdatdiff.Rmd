...
p2 <- melt(p)
colnames(p2) <- c("Type_variable","Indicateur","R2_nonajusté","Evolution_teneurs")
pander(p2[,c("Evolution_teneurs","Type_variable","R2_nonajusté")])
...
occupdiff <- c("diff_var_sfp1988_2000","diff_var_prairie1988_2000","diff_var_mf1988_2000","diff_var_sth1988_2000","diff_var_cop1988_2000")


occupdiff <- c("diff_var_sfp2000_2010","diff_var_prairie2000_2010","diff_var_mf2000_2010","diff_var_sth2000_2010","diff_var_cop2000_2010")
...
for(i in occupdiff){
  cpt <- cpt + 1
  datatest <- bdatdiff[complete.cases(bdatdiff[i]),] 
