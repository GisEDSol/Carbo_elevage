...
melted.bdatdiff <- sqlQuery(loc,paste("select diffmedian,diff,period,code_reg,nom_region,typo_clim,zonage_cplt,zonage_simple from dm_traitements.melted_bdatdiff",sep=""),as.is=c(FALSE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE))
melted.bdatdiff <- melted.bdatdiff[complete.cases(melted.bdatdiff$typo_clim),]
