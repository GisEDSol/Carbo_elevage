...
```{r map_evol_fr, echo = F, results = 'asis'}
...
```{r map_carbo_fr_picar, echo = F, results = 'asis'}
# Pour insérer l'image
fichiers <- paste(repsortie,nomfichier,sep="")
cat(paste("![](",fichiers,")",sep=""))
```
...
```{r,highlight=TRUE,eval=FALSE,fig.height=6, fig.width=6,fig.cap = fig$cap("acp_evolution_picardie","Classification de l'importance des variables explicatives par classes de région d'élevage après une modélisation par arbres de régressions boostés"),fig.align="center"}
...
```{r,echo=FALSE,eval=TRUE,fig.height=6, fig.width=12,fig.cap = fig$cap("boxplot_NPC_picardie","boxplot NPC_picardie"),fig.align="center"}
