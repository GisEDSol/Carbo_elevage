...
L'objectif de ce fichier est de réaliser l'ensemble des traitements associés à la préparation des données associées au recencement agricole (RA). La préparation des données du RA comprend essentiellement le développement de tables directement exploitables pour de la cartographie ou des analyses statistiques, à savoir :
