...
Rcovar <- c("var_mf1970_2010","var_mf1979_2010","var_mf1988_2010","var_mf2000_2010","var_mf1970_2000","var_mf1979_2000","var_mf1988_2000")
...
for(i in Rcovar){
    ...
    p[[i]] <- ggplot(dataplot, aes_string(i,"diffmedian14")) +
                ...
                annotate("text", x=0, y=5, label=lm_eqn(lm(dataplot[,"diffmedian14"]~dataplot[,i], dataplot)), parse=TRUE)+
                geom_smooth(method = "lm", se = FALSE,color="black")    
}
 
do.call(grid_arrange_shared_legend,c(p,list(nrow=2,ncol=4,position="bottom")))
```
