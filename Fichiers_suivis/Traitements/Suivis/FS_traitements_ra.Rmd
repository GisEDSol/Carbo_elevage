...
cat(paste("![Cartographie de l\'occupation du sol ",variablecarto,"](",fichiers,")",sep=""))
```
...
style_classe <- "quantile" #"pretty"#"jenks"
fichiers <- paste(github_url,"Fichiers_suivis/Traitements/Fichiers/",variablecarto,style_classe,".png",sep="")
cat(paste("![Cartograpahie des ugb tous aliments](",fichiers,")",sep=""))
```
...
ggplot(melted.radiff_select[melted.radiff_select$variable %in% c("prairie","sth","c","mf"),],aes(classe,fill=zonage_cplt))+geom_bar(position="dodge")+facet_wrap(~
