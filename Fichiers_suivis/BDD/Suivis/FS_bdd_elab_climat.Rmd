...
**Important** Rajouter une fiche nomenclature pour le climat afin de faciliter la création des métadonnées dans la base.
...
variablecarto <- "argi_med"
l_legend <- "Médiane du taux d'argile (g/kg)"
nomfichier <- "argi_medBDAT"
