...
Ci-dessous, les analyses des teneurs en C classées par méthode de mesure sont intégrées dans la base de données. Les analyses réalisées avec la méthode oxydation humide sont nommées `corgox` et les analyses mesurées avec la méthode combustion sèche `corgco`.
...
bdgsf <- sqlQuery(loc,paste("select * from ",schema,".sgdb limit 1",sep=""))
...
Ci-dessous, intégration des rasters dans la base postgreSQL/postGIS.
