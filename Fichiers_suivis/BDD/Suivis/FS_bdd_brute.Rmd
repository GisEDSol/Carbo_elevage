...
ListBDAT <- gsub("\\.csv$","",list.files(paste(repBDAT,"BDAT_harmonisee/mediane/",sep=""),pattern="\\.csv$"))
...
for(i in ListBDAT){
    ...
    # Lecture du fichier
    txtBDAT <- read.csv(paste(repBDAT,"BDAT_harmonisee/mediane/",i,".csv",sep=""),sep=";",header=TRUE,colClasses=c("Canton"="character"),encoding = "latin1")
...
ListBDAT <- gsub("\\.csv$","",list.files(paste(repBDAT,"BDAT_harmonisee/dquartile/",sep=""),pattern="\\.csv$"))
  ...
  for(i in ListBDAT){
    ...
    # Lecture du fichier
    txtBDAT <- read.csv(paste(repBDAT,"BDAT_harmonisee/dquartile/",i,".csv",sep=""),sep=";",header=TRUE,colClasses=c("Canton"="character"),encoding = "latin1")
