...
L'ensemble des feuilles excel du fichier stats_clc_commune_niveau_2.xls téléchargé à cette [adresse](http://www.statistiques.developpement-durable.gouv.fr/clc/fichiers/) sont introduites dans la base de données dans le schéma `clc`. Les données représentent la surface des occupations du sol clc de niveau 2 par canton.
