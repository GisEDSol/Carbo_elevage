...
la liste d'instructions suivante intègre les analyses des teneurs de la BDAT ré-échantillonnées dans la base de données. Ci-dessous, ce sont les analyses provenant des deux méthodes de mesures du carbone qui sont intégrées (oxydation humide+combustion sèche)
...
bdgsf <- sqlQuery(loc,"select * from bdgsf.sgdb")
...
# Intégration des tables attributaires
