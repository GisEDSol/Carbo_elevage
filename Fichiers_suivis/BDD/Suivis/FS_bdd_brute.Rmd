...
### Importation des données de la BDAT non harmonisées (obsolète)
...
Le zonage intégré dans la base a été fourni par Christophe Perrot. Pour plus d'information sur la construction, contacter l'auteur.
