...
Le résultat des traitements est accessible dans la table `dm_vecteurs.canton` et l'exploitation des traitements est réalisé dans le fichier [Analyses_RA.Rmd](https://github.com/Rosalien/GISEDSol/tree/master/Fichiers_suivis/Traitements/Suivis/Analyses_RA.Rmd)
...
A la suite de ce traitement, la table de travail enregistrée est stocké sous le nom de `r tablename`.
