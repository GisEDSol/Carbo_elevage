...
# Calcul de la densité des autres UGB (voir pour supprimer)
...
```{r,highlight=TRUE,eval=FALSE}
# Paramètres
varia <- c("p_sth","p_sfp","p_prairie","p_c","p_mf") # Variable à analyser 
...
varia <- apply(expand.grid(p_variable,period),1, function(x){paste("var_",x[1],x[2],sep="")})
