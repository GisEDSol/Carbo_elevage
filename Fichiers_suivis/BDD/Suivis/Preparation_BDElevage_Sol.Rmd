...
Les données du recensement agricole ont été extraites de requêtes lancées sur [Disard](lien vers Disard). L'ensemble des tables intégrées dans la base de données sont présentées dans le tableau ci-dessous.
